...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11, height=4,text='+',relief='flat',bg='orange',command=lambda:self.show('+')).place(x=270 ,y=275)
        Button(width=11, height=4,text='-',relief='flat',bg='orange',command=lambda:self.show('-')).place(x=270 ,y=200)
        Button(width=11, height=4,text='/',relief='flat',bg='orange',command=lambda:self.show('/')).place(x=270 ,y=50)
        Button(width=11, height=4,text='X',relief='flat',bg='orange',command=lambda:self.show('*')).place(x=270,y=125)
